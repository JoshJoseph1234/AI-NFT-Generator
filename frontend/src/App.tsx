      ...
      <div className="relative">
        ...
        <nav className="flex justify-between items-center p-6 lg:p-8">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-lg lg:text-xl font-mono tracking-wider">OPULENT NFTs</span>
          </div>
          ...
          <div className="lg:hidden flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#ADFF2F" className="w-6 h-6">
        ...
        {/* Hero Section */}
        <div className="flex flex-col lg:flex-row justify-between px-6 lg:px-16 py-12 lg:py-20">
          {/* Left Side: Text Content */}
          <div className="flex-1 max-w-2xl mb-8 lg:mb-0">
            <h1 className="text-[#ADFF2F] text-5xl lg:text-7xl font-light leading-tight tracking-tight mb-6 font-['Helvetica'] letter-spacing-[-0.05em]">
            ...
            <p className="text-gray-400 font-mono text-base lg:text-lg mb-6 tracking-wide leading-relaxed opacity-0 animate-fade-in">
            ...
            <div className="flex flex-col lg:flex-row space-y-4 lg:space-y-0 lg:space-x-4">
              <button 
                ...
                className="px-6 lg:px-8 py-3 bg-[#ADFF2F] text-black font-bold rounded hover:bg-[#9AE62F] transition-colors transform hover:scale-105"
              >
                GET STARTED
              </button>
              <button className="px-6 lg:px-8 py-3 border border-[#ADFF2F]/30 text-[#ADFF2F] rounded hover:bg-[#ADFF2F]/10 transition-colors transform hover:scale-105">
                LEARN MORE
              </button>
            </div>
          </div>
          ...
          <div className="flex-1 relative w-full lg:w-[500px] h-auto lg:h-[500px] mt-8 lg:mt-0">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 lg:w-80 h-72 lg:h-96 bg-gradient-to-br from-[#ADFF2F]/20 to-transparent border border-[#ADFF2F]/30 rounded-lg overflow-hidden animate-float">
              <img 
            ...
            <div className="absolute top-0 right-0 w-32 lg:w-48 h-48 lg:h-60 bg-gradient-to-br from-[#ADFF2F]/20 to-transparent border border-[#ADFF2F]/30 rounded-lg overflow-hidden rotate-12 animate-float-delayed-1">
              <img 
            ...
            <div className="absolute bottom-0 left-0 w-32 lg:w-48 h-48 lg:h-60 bg-gradient-to-br from-[#ADFF2F]/20 to-transparent border border-[#ADFF2F]/30 rounded-lg overflow-hidden -rotate-12 animate-float-delayed-2">
              <img 
